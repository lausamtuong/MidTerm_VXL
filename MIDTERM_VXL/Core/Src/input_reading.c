...
int button_holding_flag[NO_OF_BUTTONS];
...
void button_reading()
{
	for(unsigned char i = 0; i < NO_OF_BUTTONS; i++)
	{
		...
		{
			case 0:
				debounceButtonBuffer2[i] = HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_13);
				break;
			case 1:
				debounceButtonBuffer2[i] = HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_14);
				break;
			case 2:
				debounceButtonBuffer2[i] = HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_15);
				break;
			default:
